...
function f8() {
    ...
    if(input in a8){
       document.querySelector('.out-8').innerHTML=a8[input]
    }
    else{
...
function f9() {
    ...
    if(inputValue.length!==0){
        let keys=[]
        for(let key in a9){
            if (a9[key]==inputValue) keys.push(key);
        }
        if(keys.length>0){
            out.innerHTML=keys.join(' ')
...
function f11() {
    const inputValue=document.querySelector('.i-11').value;
    for(let key in a11){
        if (key===inputValue)  delete a11[key];
    }
     f5(a11,'.out-11');
}   
...
function f12() {
    const inputValue=+document.querySelector('.i-12').value;
    for(let key in a12){
...
function f13() {
    ...
    for(let keys of Object.values(a13)){
...
function f18() {
    let out='';
    const inputV=document.querySelector('.i-18').value;
    for(let key in a18){
       if(inputV===key){
...
function f19() {
    const inputV=document.querySelector('.i-19').value;
    let out='';
    for(let key in a19){
        if(key==inputV.toLowerCase()){
            document.querySelector('.out-19').style.background=inputV;
