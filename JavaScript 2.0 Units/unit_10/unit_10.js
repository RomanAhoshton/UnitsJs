...
function f3() {
   ...
   document.querySelector('.out-3').innerHTML=out3.length;
...
function f7() {
    let a =ar7.push('italy','turkey','vietnam');
...
function f8() {
    ...
    for(let i=0;i<ar8.length;i++){
     ...
     document.querySelector('.out-8-1').innerHTML=out8.length;
...
function f17() {
    ...
    for(let i=0;i<ar17.length;i++){
        if(ar17[i]>3){
             array17[array17.length]=ar17[i]
        }

    }
  document.querySelector('.out-17').innerHTML=array17.length;
}
...
function f18() {
    ...
    document.querySelector('.out-18').innerHTML=num;
}
