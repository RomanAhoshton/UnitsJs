...
function f1(){ 
   ...
   let b = input.value;
   let out = document.querySelector('.out-1').innerHTML=b==4;
...
function f3(){
   const input = document.querySelector('.i-31');
   const input1 = document.querySelector('.i-32');
   let inv=+input.value;
   let inv1=+input1.value;
   if(inv>inv1){
      document.querySelector('.out-3').innerHTML=inv;

   }
   else {
      document.querySelector('.out-3').innerHTML=inv1;
   }
}
...
function f5(){
   const input=document.querySelector('.i-5');
   let b =input.value;
   if(b<0){
...
function f7(){
     const input=document.querySelector('.i-71');
     let a=input.value;
     const input1=document.querySelector('.i-72');
     let b=input1.value;
     let p=document.querySelector('.out-7').innerHTML=Math.pow(a,b);
...
function f10(){
   ...
   let out=document.querySelector('.out-10').innerHTML=select;
}
...
function f11(){
   ...
   let out=document.querySelector('.out-11').innerHTML=select;
...
function f12(){
    let v = i120.value;
    document.querySelector('.out-12').innerHTML = (typeof i120);
...
function f13(){
   ...
   let b =input.value;
   let out=document.querySelector('.out-13').innerHTML=(typeof b)
    // Если принудительно не менять тип данных с помощью JS,то по умолчанию все данные от пользователя мы будем получать в виде строк.
}
...
function f14(){
   ...
   let input1=document.querySelector('.i-142');
   let b=input1.value;
   let d=+input1.value
...
function f15(){
   let select=document.querySelector('.s-151');
   let a=select.value;

   let select1=document.querySelector('.s-152');
   let b=select1.value;

   let select2=document.querySelector('.s-153');
   let c=select2.value;
