...
function t6() {
    let outStr=''
    let num=0;
    let c =+document.querySelector('.i-6').value;
    while(num<c){
    ...
    let out=document.querySelector('.out-6').innerHTML=outStr;
...
function t7() {
    let c=+document.querySelector('.i-7').value;
    let num=0;
    let outStr ='';
    while(num<=c){
        outStr+=c+'_';
 ...
 document.querySelector('.out-7').innerHTML=outStr;
}
...
function t14() {
    let r=document.querySelectorAll('.i-14');
    let out=document.querySelector('.out-14');
    let i=0;
    while(i<r.length){
         if(r[i].checked){
            out.innerHTML=r[i].value;
         }
        i++;
    }
}
