...
function t10() {
   ...
   document.querySelector('.out-10').innerHTML=(i10.value*20);
...
function t11() {
   ...
   document.querySelector('.out-11').innerHTML=b+55;
...
function t12() {
   const userName1 = document.querySelector('.i-12-2');
   const userName2 = document.querySelector('.i-12-1');
   const n = userName1.value;
   const s = userName2.value;
   const h = 'Hello';

   document.querySelector('.out-12').innerHTML=(`${h} ${s} ${n}`);
...
function t13() {
   let input1 = document.querySelector('.i-13-1');
   let input2 = document.querySelector('.i-13-2');
   let a = +input1.value;
   let b = +input2.value;
...
function t14() {
   ...
   let input3 = document.querySelector('.i-14').value="Go";
...
function t15() {
   let input4=document.querySelector('.i-15');
...
function t19() {
   const input=document.querySelector('.i-19-1');
   const input1=document.querySelector('.i-19-2');
   let a =+input.value;
   let b =+input1.value;
