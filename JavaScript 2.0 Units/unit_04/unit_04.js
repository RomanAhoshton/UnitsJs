...
function f5() {
    ...
    if(myCheckbox.checked){
        out.innerHTML=myCheckbox.value;
    }
    else{
...
function f9() {
    ...
    if(radio.checked){
        ...
        out.innerHTML=radio==radio.checked;
    }
...
function f11() {
    ...
    let b=input.value;
    let input1 =document.querySelector('.i-112');
    input1.value=b;
...
function f14() {
    ...
    document.querySelector('.out-14').innerHTML=text;
...
function f15() {
    ...
    let b=input.value;
    let out=document.querySelector('.out-15').innerHTML=b;
    let area=document.querySelector('.t-15').innerHTML=b;
...
let b=select.value;
document.querySelector('.out-16').innerHTML=b;
...
let b=select.value;
document.querySelector('.out-17').innerHTML=b;
...
function f20() {
    ...
    let b=s1.value;
    let s2=document.querySelector('.s-202').value=b;
