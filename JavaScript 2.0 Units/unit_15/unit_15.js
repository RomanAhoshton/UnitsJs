...
const f4 = () => { 
    ...
    if (s4.has(input)) out.innerHTML=true;
...
const f7 = () => {
    ...
    let s= new Set(input);
    if(s.size>6) document.querySelector('.out-7').innerHTML=1;
    else if (s.size<=6) document.querySelector('.out-7').innerHTML=0;
 }
...
const f8 = () => { 
    for (let x of s8)if(x>5) ar8.push(x);
    console.log(ar8)
}
