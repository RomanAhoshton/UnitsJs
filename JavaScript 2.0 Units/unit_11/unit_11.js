...
function f14() {
    ...
    const input=document.querySelector('.i-14');
    let b=+input.value;
    for(let i=0;i<b;i++){
...
let t15=[];
function f15() {
     const input=+document.querySelector('.i-15').value;
...
function f20() {
    let arr=d20.join('');
    document.querySelector('.out-20').innerHTML=arr;
